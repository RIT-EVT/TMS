...
private:
    ...
    CO_OBJ_T objectDictionary[OBJECT_DICTIONARY_SIZE + 1] = {
        ...
        TRANSMIT_PDO_MAPPING_ENTRY_1AXX(0,1,PDO_MAPPING_UNSIGNED16),//TempSensor One
        TRANSMIT_PDO_MAPPING_ENTRY_1AXX(0,2,PDO_MAPPING_UNSIGNED16),//TempSensor Two
        TRANSMIT_PDO_MAPPING_ENTRY_1AXX(0,3,PDO_MAPPING_UNSIGNED16),//TempSensor Three
        TRANSMIT_PDO_MAPPING_ENTRY_1AXX(0,4,PDO_MAPPING_UNSIGNED16),//TempSensor Four

        TRANSMIT_PDO_MAPPING_START_KEY_1AXX(1,3),
        TRANSMIT_PDO_MAPPING_ENTRY_1AXX(1,1,PDO_MAPPING_UNSIGNED16),//Pump Speed
        TRANSMIT_PDO_MAPPING_ENTRY_1AXX(1,2,PDO_MAPPING_UNSIGNED16),//Fan One Speed
        TRANSMIT_PDO_MAPPING_ENTRY_1AXX(1,3,PDO_MAPPING_UNSIGNED16),//Fan Two Speed

        DATA_LINK_START_KEY_21XX(0,4),
        DATA_LINK_21XX(0,0,CO_TUNSIGNED16,&sensorTemps[0]),//TempSensor One
        DATA_LINK_21XX(0,1,CO_TUNSIGNED16,&sensorTemps[1]),//TempSensor Two
        DATA_LINK_21XX(0,2,CO_TUNSIGNED16,&sensorTemps[2]),//TempSensor Three
        DATA_LINK_21XX(0,3,CO_TUNSIGNED16,&sensorTemps[3]),//TempSensor Four

        DATA_LINK_START_KEY_21XX(1,3),
        DATA_LINK_21XX(1,0,CO_TUNSIGNED16,&pumpSpeed),//Pump Speed
        DATA_LINK_21XX(1,1,CO_TUNSIGNED16,&fan1Speed),//Fan One Speed
        DATA_LINK_21XX(1,2,CO_TUNSIGNED16, &fan2Speed),//Fan Two Speed
